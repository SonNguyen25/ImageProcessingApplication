...
public class ImageControllerImpl implements ImageController{
  ...
  public void process() throws IllegalStateException {
    ...
    knownCommands.put("red", (Scanner s) -> {return new GreyScale(s.next(), s.next(),
            "red");});
    knownCommands.put("green", (Scanner s) -> {return new GreyScale(s.next(), s.next(),
            "green");});
    knownCommands.put("blue", (Scanner s) -> {return new GreyScale(s.next(), s.next(),
            "blue");});
    knownCommands.put("luma", (Scanner s) -> {return new GreyScale(s.next(), s.next(),
            "luma");});
    knownCommands.put("intensity", (Scanner s) -> {return new GreyScale(s.next(), s.next(),
            "intensity");});
    knownCommands.put("max", (Scanner s) -> {return new GreyScale(s.next(), s.next(),
            "max");});

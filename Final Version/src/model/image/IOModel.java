 ...
 * The class represents the model for an image of type that are supports by ImageIO
 ...
 */
public class IOModel extends AbstractImageModel {
  /**
   ...
   * @param maxValue The maxvalue for the color.
   * @param pixels   represents all the pixels in the image.
   */
  public IOModel(int height, int width, int maxValue, Pixel[][] pixels) {
  ...
  protected ImageModel returnModel(int height, int width, int maxValue, Pixel[][] pixels) {
    return new IOModel(height, width, maxValue, pixels);
  }
}

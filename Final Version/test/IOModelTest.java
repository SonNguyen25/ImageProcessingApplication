...
/**
 * Class to test all operations and methods related to the IOModel Class.
 */
public class IOModelTest {
  ...
  public void setUp() {
    ...
    mock2 = new IOModel(2, 2, 255, pix2);
    pix3 = new Pixel[2][2];
    ...
    mock3 = new IOModel(2, 2, 255, pix3);
    pix4 = new Pixel[2][2];
    ...
    pix6 = new Pixel[6][8];
    mock6 = new IOModel(6, 8, 255, pix6);
  }

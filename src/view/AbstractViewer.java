    ...
    for (int i=0; i< copy.length;i++) {
      ...
      for (int k=0; k< copy[i].length;k++) {
        if (k == copy[i].length - 1) {
          oneLine.append(copy[i][k].getColor().get(0) + " "
                  + copy[i][k].getColor().get(1) + " "
                  + copy[i][k].getColor().get(2)) ;
        } else {
          oneLine.append(copy[i][k].getColor().get(0) + " " + copy[i][k].getColor().get(1)+ " "
                  + copy[i][k].getColor().get(2) + " ");
        }
